...
void main() {
  group('Connection Error Message Completeness Property Tests', () {
    // **Feature: mysql-driver-migration, Property 12: Connection error message completeness**
    // **Validates: Requirements 7.1**
    test('Property 12: For any connection failure, the error message should '
        'contain the host, port, database name, and failure reason', () async {
      ...
      for (var iteration = 0; iteration < 100; iteration++) {
        ...
        try {
          ...
          expect(
            ...
            reason:
                'Iteration $iteration (scenario $scenario): Should throw '
                'RepositoryException',
          );
          ...
          expect(
            ...
            reason:
                'Iteration $iteration (scenario $scenario): Should have '
                'connection type',
          );
          ...
          if (scenario == 3) {
            expect(
              ...
              isTrue,
              reason:
                  'Iteration $iteration (scenario $scenario): Error '
          ...
          expect(
            ...
            isNotNull,
            reason:
                'Iteration $iteration (scenario $scenario): Original '
        ...
        expect(
          ...
          isTrue,
          reason:
              'Iteration $iteration (scenario $scenario): Connection '
              'should fail',
        );
      }
    }, tags: ['property-test']);

    test('Property 12 (variant): Connection timeout errors should include '
    ...
    test('Property 12 (edge case): Connection error with special characters in '
        'parameters should be handled', () async {
      final specialChars = [
        'host-with-dash',
    ...
    test('Property 12 (edge case): Multiple connection attempts should provide '
        'consistent error messages', () async {
      final connection = MysqlConnection(
