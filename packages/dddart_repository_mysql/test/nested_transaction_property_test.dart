...
void main() {
  group('Nested Transaction Correctness Property Tests', () {
    ...
    // **Feature: mysql-driver-migration, Property 11: Nested transaction correctness**
    // **Validates: Requirements 6.3**
    test('Property 11: For any nested transaction structure, operations should '
      ...
      for (var iteration = 0; iteration < 100; iteration++) {
        ...
        expect(
          ...
          reason:
              'Iteration $iteration: All operations across $nestingDepth '
    ...
    test('Property 11 (variant): Nested transaction failure should rollback '
        'entire transaction tree', () async {
      ...
      for (var iteration = 0; iteration < 50; iteration++) {
        ...
        expect(
          ...
          isTrue,
          reason:
              'Iteration $iteration: Transaction should fail at level '
              '$failAtLevel',
        );
        ...
        expect(
          ...
          equals(0),
          reason:
              'Iteration $iteration: All operations should be rolled '
    ...
    test('Property 11 (edge case): Single-level nested transaction should '
        'behave like regular transaction', () async {
      // Create test table
      await helper!.connection.execute('''
    ...
    test('Property 11 (edge case): Deeply nested transactions should maintain '
        'consistency', () async {
      // Create test table
      await helper!.connection.execute('''
    ...
    test('Property 11 (edge case): Nested transaction with mixed operations '
        'should maintain atomicity', () async {
      // Create test table
      await helper!.connection.execute('''
