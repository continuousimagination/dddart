...
void main() {
  group('Transaction Commit Atomicity Property Tests', () {
    ...
    // **Feature: mysql-driver-migration, Property 9: Transaction commit atomicity**
    // **Validates: Requirements 6.1**
    test('Property 9: For any set of operations executed within a transaction, '
        'if the transaction succeeds, all operations should be committed and '
        'visible in subsequent queries', () async {
    ...
    test('Property 9 (variant): Transaction commit should be visible across '
        'different connection queries', () async {
      ...
      for (var iteration = 0; iteration < 50; iteration++) {
        // Clean up before each iteration
        await helper!.connection.execute('DELETE FROM test_commit_visibility');
        ...
        expect(
          ...
          equals(expectedCount),
          reason:
              'Iteration $iteration: All committed rows should be '
              'queryable',
        );
      }
    ...
    test('Property 9 (edge case): Transaction with updates should commit all '
        'changes', () async {
