...
void main() {
  group('Error Type Mapping Consistency Property Tests', () {
    ...
    // **Feature: mysql-driver-migration, Property 8: Error type mapping consistency**
    // **Validates: Requirements 4.4, 7.4**
    test('Property 8: For any database error condition (duplicate key, '
      ...
      for (var iteration = 0; iteration < 100; iteration++) {
        ...
        switch (scenario) {
          ...
          case 2:
            ...
            try {
              ...
              expect(
                ...
                reason:
                    'Iteration $iteration: Should map to unknown or '
                    'connection type',
              );
          ...
          case 3:
            ...
            // Clean up
            await helper!.connection.execute(
              'DROP TABLE test_child_$iteration',
            );
            await helper!.connection.execute(
              'DROP TABLE test_parent_$iteration',
            );
        }
      }
    ...
    test('Property 8 (variant): Connection errors should consistently map to '
    ...
    test('Property 8 (edge case): Multiple errors of same type should map '
        'consistently', () async {
      ...
      for (var iteration = 0; iteration < 50; iteration++) {
        ...
        try {
          ...
          expect(
            ...
            equals(RepositoryExceptionType.duplicate),
            reason:
                'Iteration $iteration: Should consistently map to '
                'duplicate type',
          );
        }
    ...
    test('Property 8 (edge case): Error information should be preserved across '
        'exception mapping', () async {
