...
void main() {
  group('Transaction Rollback Atomicity Property Tests', () {
    ...
    // **Feature: mysql-driver-migration, Property 10: Transaction rollback atomicity**
    // **Validates: Requirements 6.2**
    test('Property 10: For any set of operations executed within a transaction '
        'that encounters an error, all operations should be rolled back and '
        'the database should return to its pre-transaction state', () async {
      ...
      for (var iteration = 0; iteration < 100; iteration++) {
        ...
        expect(
          ...
          equals(1),
          reason:
              'Iteration $iteration: All $numOperations operations '
    ...
    test('Property 10 (variant): Rollback should restore state even with '
        'multiple operation types', () async {
    ...
    test('Property 10 (edge case): Rollback on exception should work even with '
        'no prior operations', () async {
      // Create test table
      await helper!.connection.execute('''
    ...
    test('Property 10 (edge case): Rollback should work with constraint '
        'violations', () async {
      ...
      for (var iteration = 0; iteration < 50; iteration++) {
        ...
        expect(
          ...
          isTrue,
          reason:
              'Iteration $iteration: Transaction should fail on '
        ...
        expect(
          ...
          equals(0),
          reason:
              'Iteration $iteration: All child inserts should be '
              'rolled back',
        );
