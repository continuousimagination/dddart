...
void main() {
  group('Query Error Message Completeness Property Tests', () {
    ...
    // **Feature: mysql-driver-migration, Property 13: Query error message completeness**
    // **Validates: Requirements 7.2**
    test('Property 13: For any query failure, the error message should contain '
        'the SQL statement and the database error details', () async {
        ...
        switch (scenario) {
          ...
          case 2:
            ...
            await helper!.connection.execute('''
              ...
              ''');
            sql =
                'SELECT nonexistent_column_${random.nextInt(1000)} '
          ...
          case 3:
            ...
            await helper!.connection.execute('''
              ...
              ''');
            sql =
                'SELECT * FROM test_query_error_$iteration '
          ...
          case 4:
            ...
            await helper!.connection.execute('''
              ...
              ''');
            sql =
                'SELECT INVALID_FUNCTION_${random.nextInt(1000)}(id) '
                'FROM test_query_error_$iteration';
    ...
    test('Property 13 (variant): Parameterized query errors should include '
        'parameter information', () async {
    ...
    test('Property 13 (edge case): Query errors with special characters should '
        'be handled', () async {
    ...
    test('Property 13 (edge case): Constraint violation errors should include '
        'constraint details', () async {
