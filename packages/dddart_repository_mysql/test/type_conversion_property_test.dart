...
void main() {
  group('Type Conversion Consistency Property Tests', () {
    ...
    group('Property 15: Type conversion consistency', () {
      test('should preserve UuidValue through encode/decode round-trip', () {
      ...
      test('should preserve DateTime through encode/decode round-trip', () {
      ...
      test('should handle edge case UUIDs consistently', () {
      ...
      test('should handle edge case DateTimes consistently', () {
      ...
      test('should maintain type mapping consistency', () {
      ...
      test('should encode/decode UUIDs consistently across multiple calls', () {
      ...
      test('should handle UUID decoding from List<int> format', () {
      ...
      test('should handle DateTime decoding from string format', () {
      ...
      test('should throw ArgumentError for invalid UUID input', () {
        // Test null input
        expect(
      ...
      test('should throw ArgumentError for invalid DateTime input', () {
        // Test null input
        expect(
