...
@GenerateRestRepository(aggregateType: Record, serializerType: Codec,
  generatedBaseName: 'Probe', conditionalWrites: $conditional,
  implements: ${port ?? 'null'}, resourcePath: '/VersionedRecord',)
class Binding {}
""",
...
void main() {
  test('emits typed conditional repository with explicit mode', () async {
    ...
    expect(code, contains('RestConditionalRepository<Record>'));
