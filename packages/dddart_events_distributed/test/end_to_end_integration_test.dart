...
void main() {
  group('End-to-End Integration Tests', () {
    ...
    test('server publishes event, client receives it', () async {
    ...
    test('client publishes event, server receives it', () async {
    ...
    test('catch-up after simulated disconnect', () async {
      ...
      final initialTimestamp = DateTime.now().subtract(
    ...
    test('authorization filtering blocks unauthorized events', () async {
