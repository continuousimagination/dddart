...
void main() {
  group('Cleanup Integration Tests', () {
    ...
    test('cleanup deletes old events and retains recent events', () async {
    ...
    test('cleanup with no retention duration logs warning', () async {
    ...
    test('cleanup handles edge case at retention boundary', () async {
      // Requirements: 12.1, 12.2, 12.3
      // Arrange: Create server with retention duration
      const retentionDuration = Duration(hours: 1);
      server = EventBusServer<StoredEvent>(
    ...
    test('cleanup with large number of events', () async {
      // Requirements: 12.1, 12.2, 12.3
      // Arrange: Create server with retention duration
      const retentionDuration = Duration(hours: 1);
      server = EventBusServer<StoredEvent>(
