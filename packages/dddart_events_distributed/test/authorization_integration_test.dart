...
void main() {
  group('Authorization Integration Tests', () {
    ...
    test('events filtered by user context', () async {
    ...
    test('events filtered by tenant context', () async {
      // Requirements: 4.1, 4.2, 4.3, 4.4, 5.1, 5.2, 5.3
    ...
    test('complex authorization filter with multiple conditions', () async {
      // Requirements: 4.1, 4.2, 4.3, 4.4, 5.1, 5.2, 5.3
