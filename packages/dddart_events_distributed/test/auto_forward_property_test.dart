...
void main() {
  group('Property 9: Auto-forward sends events to server', () {
    test('should POST events to server when autoForward is enabled', () async {
      ...
      for (var i = 0; i < 100; i++) {
          ...
          if (request.url.path.endsWith('/events')) {
            if (request.method == 'POST') {
              ...
              return http.Response(
                jsonEncode({'id': body['id'], 'createdAt': body['createdAt']}),
                201,
        ...
        for (var j = 0; j < eventCount; j++) {
          ...
          final eventJson =
              jsonDecode(forwardedEvent['eventJson'] as String)
    ...
    test('should forward events with authorization context', () async {
    ...
    test('should continue forwarding after POST failures', () async {
    ...
    test('should forward multiple events in order', () async {
