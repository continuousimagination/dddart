...
import 'package:dddart_rest/src/generators/jwt_claims_generator.dart';
...
''',
  ...
  final annotation = element.metadata.annotations.firstWhere(
    (a) => a.computeConstantValue()?.type?.element?.name == 'JwtSerializable',
  );
  return JwtClaimsGenerator().generateForAnnotatedElement(
    element,
