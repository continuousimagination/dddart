...
- [ ] 1.1 Create dddart_events_distributed package structure
...
- [ ] 1.2 Implement StoredEvent aggregate root
...
- [ ] 1.3 Write property test for StoredEvent serialization
  - **Property 2: Serialization preserves event data**
  - **Validates: Requirements 1.3**

- [ ] 1.4 Implement EventRepository abstract class
...
- [ ] 2. Implement EventBusServer component
- [ ] 2.1 Create EventBusServer class with event persistence
...
- [ ] 3.3 Write property test for authorization filtering
  - **Property 7: Authorization filter controls event delivery**
  - **Validates: Requirements 4.3**

- [ ] 3.4 Write property test for no-filter behavior
  - **Property 8: No filter means all events delivered**
  - **Validates: Requirements 4.5**

- [ ] 3.5 Implement POST /events endpoint
...
- [ ] 3.6 Write unit tests for HTTP endpoints
...
- [ ] 4. Implement EventBusClient component
- [ ] 4.1 Create EventBusClient class with polling
...
- [ ] 4.2 Implement HTTP polling logic
...
- [ ] 4.3 Write property test for polling retrieval
  - **Property 4: Polling retrieves new events**
  - **Validates: Requirements 2.2**

- [ ] 4.4 Implement event deserialization and publishing
...
- [ ] 4.8 Write property test for auto-forward
  - **Property 9: Auto-forward sends events to server**
  - **Validates: Requirements 15.3**

- [ ] 4.9 Write property test for disabled forwarding
  - **Property 10: Disabled forwarding prevents automatic POST**
  - **Validates: Requirements 15.4**

- [ ] 4.10 Add close() method to EventBusClient
...
- [ ] 5. Implement event registry code generation
- [ ] 5.1 Create code generator for event registry
...
- [ ] 5.2 Write unit tests for code generator
...
- [ ] 6.1 Create example domain events and custom StoredEvent
...
- [ ] 6.2 Create in-memory repository example
...
- [ ] 6.3 Write property test for time-range queries
  - **Property 3: findSince returns events in time range**
  - **Validates: Requirements 11.3**

- [ ] 6.4 Create server example
